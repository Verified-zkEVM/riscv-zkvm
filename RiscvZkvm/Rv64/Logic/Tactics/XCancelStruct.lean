/-
  RiscvZkvm.Rv64.Tactics.XCancelStruct
  ...
  `_right` / `_mid_left` lives in `RiscvZkvm/Rv64/Logic/SepLogic.lean` (#245 slice 3-pre,
  PR #1661).
  ...
  - `RiscvZkvm/Rv64/Logic/SepLogic.lean` — `sepConj_eq_congr_*` family + `sep_perm`.
-/
...
namespace RiscvZkvm.Rv64.Tactics.XCancelStructTests
...
end RiscvZkvm.Rv64.Tactics.XCancelStructTests
