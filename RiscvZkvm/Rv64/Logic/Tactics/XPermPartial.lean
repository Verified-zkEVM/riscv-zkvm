...
`xperm` (defined in `RiscvZkvm/Rv64/Logic/Tactics/XPerm.lean`) closes a goal
...
1. **`sepConj_mono_left/right` are monotonicity, not projection.** They
   ...
   from the chain.
2. **`sepConjElim_right` does not exist** in `RiscvZkvm/Rv64/Logic/SepLogic.lean`.
...
1. `evm-asm's EvmAsm/Evm64/Shift/ShlCompose.lean` lines 310–322 / 456–462 /
...
2. `evm-asm's EvmAsm/Rv64/RLP/Phase2LongLoopThree.lean` lines 100–110 and
...
3. `evm-asm's EvmAsm/Evm64/Byte/Spec.lean` lines 289–299, 407–417, 780–906,
