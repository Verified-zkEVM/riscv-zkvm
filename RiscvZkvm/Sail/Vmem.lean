...
import RiscvZkvm.Sail.VmemPte
import RiscvZkvm.Sail.VmemPtw
import RiscvZkvm.Sail.Callbacks0
...
/-- Type quantifiers: k_ex499979_ : Bool, level : Nat, k_ex499977_ : Bool, k_ex499976_ : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex500056_ : Bool, k_ex500055_ : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex500076_ : Bool, k_ex500075_ : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex500111_ : Bool, k_ex500110_ : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
